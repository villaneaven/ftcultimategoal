...
@Autonomous
public class WobbleDropForSecondTeam extends LinearOpMode
{
...
//        armleft.setPower(0);
    ...
    public static class SkystoneDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(179,20);//changes position of box y is left and right the lower the more right it goes, the lower the number the higher it goes 210, 95
